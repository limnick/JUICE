...
Level.prototype.showHealthBars = function() {
...
Level.prototype.cropHealthBar = function() {
...
Level.prototype.first_block_hit = function(player, block) {
...
Level.prototype.machinegun_trigger_hit = function() {
...
Level.prototype.showEnemy = function() {
...
Level.prototype.updateEnemyHealthbar = function() {
...
Level.prototype.playerHit = function(player, bullet) {
	this.player.damage(5);
	bullet.kill();
};

Level.prototype.enemyHit = function(bullet, enemy) {
	bullet.kill();
